...
class LabelsTest(unittest.TestCase):
    def test_counts(self):
        ...
        counts = {0: 2, 1: 3, 2: 2}
        self.assertDictEqual(tracking.count_labels(label_image, exclude_zero=False),
                             counts)

        # Test excluding zero labels_stack
        counts.pop(0)
        self.assertDictEqual(tracking.count_labels(label_image, exclude_zero=True),
                             counts)
    ...
    def test_intersections(self):
        ...
        self.assertDictEqual(tracking.intersection_between_labels(label_image_1, label_image_2, exclude_zero=False),
                             intersections)
        ...
        for value in intersections.values():
            value.pop(0, None)
        self.assertDictEqual(tracking.intersection_between_labels(label_image_1, label_image_2, exclude_zero=True),
                             intersections)
